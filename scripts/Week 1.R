...
plot_usmap(data = pv_map_grid, regions = "states", values = "winner", color = "white") +
  ...
  theme(strip.text = element_text(size = 12),
        aspect.ratio=1) +
  labs(title = "State-Level Presidential Popular Vote, 1980-2016")

ggsave("PV_win_states_historical.png", height = 6, width = 9)
...
ggsave("PV_states_historical.png", height = 6, width = 9)
