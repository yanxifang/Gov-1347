...
- **Economy**: State-level unemployment was originally a poor predictor, but using *state-level personal income data* from the [U.S. Bureau of Economic Analysis (BEA)](https://apps.bea.gov/regional/downloadzip.cfm), 
