...
In my analysis, I used data from the U.S. CDC on [COVID-19 deaths at the county level](https://data.cdc.gov/NCHS/Provisional-COVID-19-Death-Counts-in-the-United-St/kn79-hsxy). For the first model, I merged this dataset with county-level popular vote share data for 2000-2016, as well as county-level demographics (age groups, gender, and race/ethnicity) data. 
