...
Obviously, there are many other variables - beyond the economy and polling averages - that could partially explain the state-level election outcomes. My hypotheses for these other variables are:
